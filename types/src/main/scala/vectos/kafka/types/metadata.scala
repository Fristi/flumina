...
trait MetadataTypes {
  ...
  final case class MetadataTopicPartitionMetadataResponse(errorCode: KafkaError, id: Int, leader: Int, replicas: Vector[Int], isr: Vector[Int])
  final case class MetadataTopicMetadataResponse(topicErrorCode: KafkaError, name: String, partitionMetaData: Vector[MetadataTopicPartitionMetadataResponse])
